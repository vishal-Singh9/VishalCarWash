...
export default function BookingPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const sessionResponse = await fetch(
        `${API_ENDPOINTS.bookings.replace("/bookings", "")}/auth/session`
      );
  ...
  const filteredServices = Array.isArray(services) 
    ? services.filter((service) => {
        ...
        if (activeCategory === "basic" && service.name.includes("Basic")) return true;
        if (activeCategory === "deluxe" && service.name.includes("Deluxe")) return true;
        if (activeCategory === "premium" && service.name.includes("Premium")) return true;
        if (activeCategory === "interior" && service.name.includes("Interior")) return true;
        if (activeCategory === "full" && service.name.includes("Full")) return true;
        return false;
      })
    : [];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="inline-block px-4 py-2 mb-6 text-sm font-medium text-blue-100 bg-white/10 backdrop-blur-sm rounded-full border border-white/20"
            >
            ...
            >
              Experience premium car care with our professional services. Book
              now and give your car the shine it deserves.
            </motion.p>
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="flex flex-col items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-3 rounded-lg border border-white/10"
                >
                ...
                <div className="flex items-center justify-between">
                  {[
                    ...
                    >
                      ...
                      {index < 1 && (
                        <div
                          className={`hidden md:block absolute left-3/4 w-full h-1 top-6 ${
                            activeStep > step
              ...
              {activeStep === 1 && (
                <div className="space-y-8">
                  ...
                  <Tabs
                    ...
                    className="w-full"
                  >
                    <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 p-1 bg-gray-100 rounded-xl overflow-x-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {loading ? (
                      [...Array(3)].map((_, i) => (
                        <div
                          key={i}
                          className="bg-gray-100 rounded-2xl p-6 animate-pulse h-48"
                        ></div>
                      ))
                          ...
                          <div className="relative z-10">
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <motion.span
                                ...
                                className="px-3 py-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full text-sm font-semibold shadow-md group-hover:shadow-lg whitespace-nowrap"
                              >
