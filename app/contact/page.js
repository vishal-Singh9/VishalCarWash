  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <h3 className="text-base sm:text-lg font-semibold sm:font-bold text-white mb-1.5 sm:mb-2 flex items-center">
          {title}
        ...
        <div className="text-sm sm:text-base text-gray-400 space-y-1 sm:space-y-1.5">
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        <motion.div
          className="absolute -right-20 -top-20 w-96 h-96 bg-white/10 rounded-full mix-blend-overlay filter blur-3xl"
          animate={{
            scale: [1, 1.1, 1],
            x: [0, 20, 0],
            y: [0, -20, 0],
        ...
        />
        <motion.div
          className="absolute -left-20 -bottom-20 w-96 h-96 bg-white/50/10 rounded-full mix-blend-overlay filter blur-3xl"
          animate={{
            scale: [1, 1.1, 1],
            x: [0, -20, 0],
            y: [0, 20, 0],
      ...
      "
          >
            {/* ================= CONTACT FORM ================= */}
            <motion.div
              className="relative bg-white/5 rounded-2xl shadow-xl overflow-hidden border border-white/10"
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <AnimatePresence>
                {isSubmitted && (
                  ...
                  >
                    <div className="bg-white/5 p-4 rounded-xl shadow-lg border border-green-100 flex items-start">
                      ...
                      <button
                        ...
                        className="ml-2 text-gray-400 hover:text-gray-400 transition-colors"
                        aria-label="Close"
                      >
                        <svg
                          className="w-4 h-4"
                ...
                {apiError && (
                  <motion.div
                    ...
                    className="fixed top-6 right-6 z-50 max-w-sm w-full"
                  >
                    <div className="bg-white/5 p-4 rounded-xl shadow-lg border border-red-100 flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-400 mt-1">{apiError}</p>
                      </div>
                      <button
              ...
              <div className="px-6 sm:px-8 py-4 bg-[#030712] border-t text-center">
            ...
            {/* ================= MAP ================= */}
            <div className="bg-white/5 p-4 sm:p-5 md:p-6 rounded-2xl shadow-lg h-full flex flex-col">
              <h4 className="text-lg font-semibold text-white mb-3 sm:mb-4">
                Visit Our Location
              </h4>
              <div className="flex-1 rounded-xl overflow-hidden border border-white/10 bg-white/10">
                <iframe
