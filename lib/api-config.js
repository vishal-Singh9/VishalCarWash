...
const getApiBaseUrl = () => {
  ...
  // In browser, use relative URLs for API calls
  if (typeof window !== 'undefined') {
    return ''; // Empty string will make the URLs relative
  }
...
export const API_ENDPOINTS = {
  ...
  bookingAvailability: `${API_BASE_URL}/api/bookings/availability`,
  ...
  // Reviews Submit
  reviewsSubmit: `${API_BASE_URL}/api/reviews`,
